...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{url('back/assets/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
                ...
                <div class="mb-3">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="terms-conditions">
                      Je suis d'accord
                      <a href="javascript:void(0);">avec la politique de cette application</a>
                    </label>
                  </div>
                </div>
                <button class="btn btn-warning d-grid w-100">s'enregistrer</button>
              </form>

              <p class="text-center">
                <span>Déjà un compte?</span>
                <a href="{{route('login')}}">
                  <span class="text-warning">se connecter ici</span>
                </a>
              </p>
            </div>
          </div>
