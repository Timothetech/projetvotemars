...
<head>
    ...
    <link rel="stylesheet" href="{{url('back/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
...
<body>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{route('dashboard')}}" class="app-brand-link text-secondary fw-bolder gap-2"> CONCOURS
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <h5 class="card-title text-warning">Visualsez les résultats du vote! 🎉</h5>
                        </div>
                        <!-- /Search -->

                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            <li class="nav-item lh-1 me-3">
                                {{-- <span class="fw-semibold d-block">Timothée Ottou</span> --}}
                        ...
                        <footer class="content-footer footer bg-footer-theme">
                            <div
                                ...
                                <div class="mb-2 mb-md-0">
                                    ...
                                    , made with ❤️ by
                                    <a href="#" target="_blank" class="footer-link fw-bolder">Timothée Ottou</a>
                                </div>
                            </div>
                        </footer>
                        <!-- / Footer -->
    ...
    <!-- Vendors JS -->
    <script src="{{url('back/assets/vendor/libs/apex-charts/apexcharts.js')}}"></script>

    <!-- Main JS -->
    <script src="{{url('back/assets/js/main.js')}}"></script>

    <!-- Page JS -->
    <script src="{{url('back/assets/js/dashboards-analytics.js')}}"></script>
    <script src="{{('back/assets/js/pages-account-settings-account.js')}}"></script>
