            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="{{route('candidates')}}" class="nav-item nav-link">Candidates</a>
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-6 text-start">
                        <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="{{asset('assets1/img/2591.png')}}">
                    </div>
                    <div class="col-6 text-start">
                        <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="{{asset('assets1/img/1941.png')}}" style="margin-top: 25%;">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="{{asset('assets1/img/1942.png')}}">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="{{asset('assets1/img/2592.png')}}">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <h5 class="section-title ff-secondary text-start text-primary fw-normal">De quoi s'agit-il ?</h5>
                <h1 class="mb-4">Présentation du <span class=" text-primary me-2">Concours de beauté Miss 8 Mars </span>Cameroun</h1>
                <p class="mb-4">Le concours de beauté Miss 8 Mars Cameroun qui a lieu le 7 Mars de chaque année est un concours qui prône l'autonomisation de la femme Africaine en général et Camerounaise en particulier.</p>
                <p class="mb-4">
                    Il a pour objectif d'inculquer dans un premier temps des valeurs d'une femme aux jeunes filles et dans un second temps valoriser les droits de la femme au travers de ces femmes qui combattent tous les jours afin de se faire une place dans la société.</p>
...
<!-- About End -->
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Nos</h5>
                    <h1 class="mb-5">Sponsors</h1>
                </div>
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="{{asset('front/sponsor1.jpg')}}" style="width: 150px; height: 150px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Bree Beauty</h5>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Liste des</h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class="rounded-circle overflow-hidden m-4">
                                <img class="img-fluid" src="{{asset('storage/{{$candidate->image}}')}}"  alt="">
                            </div>
